...
public class SofaAggregate implements Aggregate {
    ...
    @Override
    public CommandHandlingResult handle(final Command command) {
    ...
    public CommandHandlingResult createNewSofa(final CreateNewSofa command ) {
        ...
        EventFactory<CreateNewSofa, Sofa, SofaId> factory = new EventFactory<>(command, root);
    ...
    public CommandHandlingResult addLegs(final AddLegs command) {
        if (getRoot().isBare()) {
